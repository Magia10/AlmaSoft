...
public class ProductInboundActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if(productId != -1) {
                    try{
                        ...
                        Movement movement = new Movement(1, productId, Integer.parseInt(etStock.getText().toString()), formattedDate);
                        ...
                        Toast.makeText(ProductInboundActivity.this, "Movimiento registrado", Toast.LENGTH_LONG).show();
                        finish();
                    }catch (Exception e){
                        Toast.makeText(ProductInboundActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
